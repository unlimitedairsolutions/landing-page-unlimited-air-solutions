            ...
            <div class="col-md-8 col-sm-6 collapse_responsive">
                <div class="collapse navbar-collapse remove_padding" id="myNavbar">
                    <ul class="nav navbar-nav text-center main_nav_2">
                        <li>
                            <a href="index.php">Home <i class="fa fa-angle-down"></i></a> <span class="responsive_menu"><i class="fa fa-angle-down"></i></span>
...
<!--===========================
        Start Header Slider
===========================-->
<section class="header_slider_area owl-carousel home_v2_header_slider">
...
<!--===========================
        Start About
===========================-->
<section class="about_area section_border section_padding">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="about_details about_gray responsive_no_pading">
                    <div class="hero-title-with-shape">
                        <h4 class="heading_with_border">Our success story</h4>
                        <h1>Experience quality air conditioning service in broklyn new york</h1>
                    </div><!--end .hero-title-with-shape-->
                    <p>There are many variations of passages of lorem ipsum available, but the majorify have suffered
                        alteration in some form by injected humour, or randmised words which don't look even slightly
                        believable.</p>
                    <a href="service-details.php" class="btn-yellow">LEARN MORE</a>
                    <img src="assets/images/shape/service-shape.png" class="about_gray_shape" alt="about shape">
                </div><!--end .about_details-->
            </div><!--end .col-md-7-->
            <div class="col-md-5">
                <div class="about_image about_style_2_img">
                    <div class="about_2_img"></div>
                    <div class="about_service_box_1">
                        <i class="icon-maintenance"></i>
                        <h2>We make as cool again</h2>
                    </div><!--end .about_service_box_1-->
                    <div class="about_service_box_1 about_service_box_2_bg">
                        <i class="icon-big-ac"></i>
                        <h2>Keep your business cool</h2>
                    </div><!--end .about_service_box_1-->
                </div><!--end .about_image .about_style_2_img-->
            </div><!--end .col-md-5-->
        </div><!--end .row-->
    </div><!--end .container-->
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="blog_share_box">
                    ...
                    <div class="blog_share_details">
                        ...
                        <h1><a href="blog-details.php">How does a ductless heat pump work?</a></h1>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="blog_share_box">
                    ...
                    <div class="blog_share_details">
                        <span class="comment_author">by <a href="#">admin</a> - <a href="#">3 Comments</a></span>
                        <h1><a href="blog-details.php">Simple hack to improve A/C efficiency</a></h1>
                        <p>There are many variations passages of lorem ipsum available but the majority have suffered alteration.</p>
                    </div><!--end .blog_share_details-->
                </div><!--end .blog_share_box-->
            </div><!--end .col-md-4-->
            <div class="col-md-4 col-sm-6">
                <div class="blog_share_box">
                    ...
                    <div class="blog_share_details">
                        <span class="comment_author">by <a href="#">admin</a> - <a href="#">3 Comments</a></span>
                        <h1><a href="blog-details.php">Preparing your home before vacation</a></h1>
                        <p>There are many variations passages of lorem ipsum available but the majority have suffered alteration.</p>
                    </div><!--end .blog_share_details-->
                </div><!--end .blog_share_box-->
            </div><!--end .col-md-4-->
...
<section class="contact_form_area ctf_gray section_padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="contact-right contact-right-style-2">
                    <form action="#" method="post">
                        <input type="text" placeholder="Your name" class="half_width input_m_right">
                        <input type="EMAIL" placeholder="Email Address" class="half_width">
